<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Admin.Master" AutoEventWireup="true" CodeBehind="Statistics.aspx.cs" Inherits="StoreManagement.Statistic.Statistics" %>
        ...
        <li>
            <a href="#">
                ...
                <div class="ca-content">
                    ...
                    <h3 class="ca-sub">Number of Product</h3>
                </div>
            </a>
        </li>
        <li>
            <a href="#">
                ...
                <div class="ca-content">
                    ...
                    <h3 class="ca-sub one">Number of Customer</h3>
                </div>
            </a>
        </li>
        <li>
            <a href="#">
                ...
                <div class="ca-content">
                    ...
                    <h3 class="ca-sub two">Cash Register</h3>
                </div>
            </a>
        </li>
        <li>
            <a href="#">
                ...
                <div class="ca-content">
                    ...
                    <h3 class="ca-sub three">Number of Category</h3>
                </div>
            </a>
        </li>
        ...
        <li>
            <a href="#">
                ...
                <div class="ca-content">
                    ...
                    <h3 class="ca-sub">Number of Active Product</h3>
                </div>
            </a>
        </li>
        <li>
            <a href="#">
                ...
                <div class="ca-content">
                    ...
                    <h3 class="ca-sub one">Number of Passive Product</h3>
                </div>
            </a>
        </li>
        <li>
            <a href="#">
                ...
                <div class="ca-content">
                    ...
                    <h3 class="ca-sub two">Most Stocked Product</h3>
                </div>
            </a>
        </li>
        <li>
            <a href="#">
                ...
                <div class="ca-content">
                    ...
                    <h3 class="ca-sub three">Most Used Category</h3>
                </div>
            </a>
        </li>
    </ul>
